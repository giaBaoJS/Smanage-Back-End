...
class apiDashboard extends Controller
{
    ...
    public function chartadmin()
    {
        ...
        foreach ($showBill as $b) {
            $dayStart = date('m', strtotime($b->created_at));
            if ($dayStart == 1) {
                $day1 = $day1 + $b->total_price;
            }
            if ($dayStart == 2) {
                $day2 = $day2 + $b->total_price;
            }
            if ($dayStart == 3) {
                $day3 = $day3 + $b->total_price;
            }
            if ($dayStart == 3) {
                $day3 = $day3 + $b->total_price;
            }
            if ($dayStart == 4) {
                $day4 = $day4 + $b->total_price;
            }
            if ($dayStart == 5) {
                $day5 = $day5 + $b->total_price;
            }
            if ($dayStart == 6) {
                $day6 = $day6 + $b->total_price;
            }
            if ($dayStart == 7) {
                $day7 = $day7 + $b->total_price;
            }
            if ($dayStart == 8) {
                $day8 = $day8 + $b->total_price;
            }
            if ($dayStart == 9) {
                $day9 = $day9 + $b->total_price;
            }
            if ($dayStart == 10) {
                $day10 = $day10 + $b->total_price;
            }
            if ($dayStart == 11) {
                $day11 = $day11 + $b->total_price;
            }
            if ($dayStart == 12) {
                $day12 = $day12 + $b->total_price;
            }
        }
        $chart = [
            '1' => $day1,
