...
class homeController extends Controller
{
    ...
    public function news()
    {
        $showMien = mien::all();
        $showTinh = tinh::all();
        $tagTour = tour::select('tours.tag')->get();
        ...
        return view('front-end/pages/news/news', ['tagTour' => $tagTour, 'showMien' => $this->showMien, 'showComment' => $showComment, 'showNewsTotal' => $showNewsTotal, 'showNewsLimit' => $showNewsLimit, 'showNewsHighlights' => $showNewsHighlights, 'showMien' => $showMien, 'showTinh' => $showTinh]);
    }
    ...
    public function timkiem(Request $request)
    {
        $validate = $request->validate([
            ...
            'from-date' => 'required|string',
            'to-date' => 'required|string',
        ], [
            'diemden.required' => 'Không được để trống điểm đến',
            'from-date.required' => 'Bạn cần chọn ngày khởi hành',
            'to-date.required' => 'Bạn cần chọn ngày kết thúc'
        ]);
        $showMien = mien::all();
        $showTinh = tinh::all();
