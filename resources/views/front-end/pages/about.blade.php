		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="content-1">
						<img class="img-fluid" src="{{asset('FrontEnd/assets/images/defaults')}}/about-us/about_1.jpg" alt="" />
						<div class="box-text">
							<div class="sub-title">
				...
				<div class="col-12 col-md-6">
					<div class="content-1">
						<img class="img-fluid" src="{{asset('FrontEnd/assets/images/defaults')}}/about-us/about_2.png" alt="" />
						<div class="box-text">
							<div class="sub-title">
				...
				<div class="col-lg-3 col-md-6">
					<div class="tpk_card">
						...
						<div class="back">
							<div class="details">
								<p>
									GoldenTours đã có hơn 100+ tin tưởng và hợp tác trong nước và thế giới.
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="tpk_card">
						...
						<div class="back">
							<div class="details">
								<p>
									hơn 2 ngàn nét đặc trưng của 64 tỉnh thành sẽ mang đến cho bạn.
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="tpk_card">
						...
						<div class="back">
							<div class="details">
								<p>
									hơn 300+ điểm đến thú vị mà GoldenTours mang đến cho bạn. Bạn sẽ được trải nghiệm và khám phá khi đến với GoldenTours.
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="tpk_card">
						...
						<div class="back">
							<div class="details">
								<p>
									GoldenTours đã được tin tưởng và đạt móc hon 40 ngàn lượt booking tours.
								</p>
							</div>
						</div>
					</div>
		...
		<div class="swiper-container4">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img class="img-full w-100" src="{{asset('FrontEnd/assets/images/defaults')}}/about1.jpg" alt="image" />
				</div>
				<div class="swiper-slide">
					<img class="img-full w-100" src="{{asset('FrontEnd/assets/images/defaults')}}/about2.jpg" alt="image" />
				</div>
				<div class="swiper-slide">
					<img class="img-full w-100" src="{{asset('FrontEnd/assets/images/defaults')}}/about3.jpg" alt="image" />
				</div>
				<div class="swiper-slide">
					<img class="img-full w-100" src="{{asset('FrontEnd/assets/images/defaults')}}/about4.jpg" alt="image" />
				</div>
			</div>
