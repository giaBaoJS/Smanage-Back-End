...
<body>
      ...
      <div class="container-fluid px-0">
        <div class="topbar">
          ...
          <ul class="topbar-right">
            ...
            <li class="logined">
              <a href="{{ url('/') }}">
                <img src="{{asset('BackEnd/assets/images/users')}}/{{session('account')->url_avatar}}" width="30px" alt="logo">
    ...
    <div class="header__menu">
      <div class="main-header">
        <div class="container isner">
          <div class="main-logo">
            <a href="{{ url('/') }}"><img src="{{asset('FrontEnd/assets/images/defaults')}}/logo-1.png" width="100px" alt="logo" />
            </a>
          </div>
          ...
          <div class="right">
            <div class="main-menu">
              <div class="logo-mobile">
                <a href="#">
                  <img src="{{asset('FrontEnd/assets/images/defaults')}}/logo-1.png" width="100px" alt="logo" />
                </a>
              </div>
  ...
  <a href="javascript:" class="" id="return-to-top"><i class="fa fa-angle-up"></i></a>
